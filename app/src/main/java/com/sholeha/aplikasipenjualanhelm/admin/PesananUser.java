...
//        pDialog.setContentView(0);
    ...
    public void onBackPressed() {
        Intent i = new Intent(PesananUser.this, HomeAdminActivity.class);
        startActivity(i);
        finish();
    }
...
//                                                    hapusData();
                                                        ...
                                                        Toast.makeText(getApplicationContext(), "okeee", Toast.LENGTH_LONG).show();
                                                    }
                                                });
        ...
        JsonObjectRequest req = new JsonObjectRequest(Request.Method.PUT, BaseURL.editTransaksi + _id, new JSONObject(params),
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            hideDialog();
                            Log.e("Put", response.getString("msg"));
