...
import com.sholeha.aplikasipenjualanhelm.adapter.AdapterOrder;
...
public class PesananUser extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.e("username", PrefSetting.Username);
    ...
    public void onBackPressed() {
        Intent i = new Intent(PesananUser.this, HomeUserActivity.class);
        startActivity(i);
        finish();
    }
    ...
    private void getAllOrder() {
        ...
        showDialog();
        JsonObjectRequest req = new JsonObjectRequest(Request.Method.GET, BaseURL.getDataTransaksi + username, null,
...
//                                    }
                                    order.set_id(_id);
                                    order.setNamaUser(namaPembeli);
                                    order.setNamaBarang(namaHelm);
...
//                                    order.set_Id(username);
                                    list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                                        ...
                                        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                                            ...
                                            if (newsList.get(position).getStatus().equals("Proses Pengiriman")) {
...
//                                            startActivity(a);
    ...
    public void updateData(String _id) {
        ...
        params.put("status", "Pesanan Diterima");
